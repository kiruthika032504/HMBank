            ...
            while(!exitLoop)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        {
                            case 1:
                                bankService.CreateAccountUsingList(customer1, "Savings", 525000);
                                bankService.CreateAccountUsingSet(customer2, "Savings", 1299000);
                                bankService.CreateAccountUsingHashMap(customer2, "Savings", 89000);
                                Console.WriteLine("Savings Account created successfully");
                                break;
                            case 2:
                                bankService.CreateAccountUsingList(customer1, "Current", 1250040);
                                bankService.CreateAccountUsingHashMap(customer1, "Current", 90040);
                                bankService.CreateAccountUsingSet(customer2, "Current", 50500);
                                Console.WriteLine("Current Account created successfully");
                                break;
                            case 3:
                                bankService.CreateAccountUsingList(customer2, "ZeroBalance", 50000);
                    ...
                    case 6:
                        ...
                        bankService.GetAccountDetailsUsingList(accNo3);
                        break;
                    case 7:
                        bankService.ListAccountsUsingList();
                        break;
                    case 8:
